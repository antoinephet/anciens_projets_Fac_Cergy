...
public class JdbcPersonAccess {
	...
	public void create(Person object) {
		try {
			String query = "INSERT INTO person.person VALUES ('" + object.getId()
	...
	public void update(Person object) {
		try {
			String query = "Update person.person set age = " + object.getAge()
	...
	public void delete(Person object) {
		try {
			String query = "Delete from person.person where id = '" + object.getId()
					+ "';";
			System.out.println(query);
			Statement statement = getStatement();
			statement.executeUpdate(query);
