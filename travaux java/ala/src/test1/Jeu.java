...
import javax.swing.JPanel;
	...
	int	nbLigne = 30,nbColonne = 21;
	String choix;
	String grille[][] = new String[nbLigne][nbColonne];
	
	boolean choixGardien1,choixGardien2,choixGardien3,choixGardien4;
	...
	public Jeu(){
		...
		/*
		 * choix = JOptionPane.showInputDialog("Votre choix");
		if(choix.equals("2")){
		...
		System.out.println(nbLigne + " " + nbColonne);
		 * 
		 */
	...
	public void chargerCarte(){
		...
		try{	
			...
			// si la taille de l'écran est 20x20, alors le fichier Carte2.txt sera lu 
			...
			// si la taille de l'écran est 30x21, alors le fichier Carte3.txt sera lu 
