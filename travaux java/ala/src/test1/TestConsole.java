...
public class TestConsole {
	...
	public static void main(String[] args) {
		...
		System.out.println("\n\n");
		System.out.println("Les gardiens sont représentés par G,S,C et P");
		System.out.println("Et les Intrus sont représentés par I,R et D");
		...
		System.out.println("\n\n");
		System.out.println("Test des mouvements aléatoire des gardiens et des intrus...");
		System.out.println("\n\n");
